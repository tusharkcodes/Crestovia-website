...
export default function StatCard({ stat, index }) {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center backdrop-blur-sm transition-colors hover:border-accent/30 hover:bg-white/10 sm:p-8"
    >
