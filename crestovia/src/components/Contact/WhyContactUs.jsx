          ...
          {whyContactUs.map((item) => {
            ...
            return (
              <motion.article
                key={item.title}
                variants={fadeInUp}
                className="group rounded-2xl border border-border bg-surface p-6 shadow-lg shadow-primary/5 transition-all duration-300 hover:scale-[1.02] hover:border-primary/20 hover:shadow-xl sm:p-8"
              >
